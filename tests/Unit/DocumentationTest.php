...
class DocumentationTest extends TestCase
{
    ...
    public function bilingual_api_docs_exist(): void
    {
        ...
        foreach ([
            ...
            'DELETE /api/v1/admin/readers/{reader}',
            ...
            // ADR-051 — the 12→22 surface: every new name pinned so
            // documentation drift fails the build (plus the present
            // list, which the TASK-027 needles never covered).
            ...
            // TASK-037 — PAE parity + the settings/kitchen/reports surfaces.
            'get_missed_meals',
    ...
    public function postman_collection_exists_and_is_valid_json(): void
    {
        ...
        foreach ([
            ...
            '{{base_url}}/api/v1/admin/readers/{{reader_id}}',
