...
| `/admin/reports/attendance` | admin | **Reportes de asistencia**: presentes/tarde/ausentes por día con desglose por clase y gráficas, agregados mensuales, ausentes frecuentes, historial por estudiante — con exportación a PDF y CSV |
| `/admin/reports/recycling` | admin | **Reportes de reciclaje**: rendimiento diario/mensual con gráficas, mezcla de materiales, clasificación por puntos, historial por estudiante — con exportación a PDF y CSV |
| `/admin/staff` | admin | **Cuentas de personal** (TASK-038): crea accesos de admin/profesor/cocina con contraseña temporal (rotación obligada en el primer inicio); los profesores pueden tomar clases a cargo en la misma petición |
