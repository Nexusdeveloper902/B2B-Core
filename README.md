...
| `/admin/reports/attendance` | admin | **Attendance reports**: daily present/late/absent with per-class breakdown and charts, monthly aggregates, repeat absentees, per-student history — with PDF and CSV exports |
| `/admin/reports/recycling` | admin | **Recycling reports**: daily/monthly yields with charts, material mix, points leaderboard, per-student history — with PDF and CSV exports |
