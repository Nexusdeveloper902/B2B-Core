...
- [x] Guarded both layers (confirm unless --force); empty table is a
      clean noop
- [x] 6 tests (+1 ScriptSuiteTest data-provider case for the new
      command); suite = 168 passed / 3 skipped (was 161)
...
- [x] Fresh-clone catches fixed: pre-`./run setup` invocation dies
      bilingual-friendly (7bb0673), and a present-but-unmigrated DB
      fails fast with remediation instead of a traceback (9fbc576,
      6th test pins it) — re-merged as b6be717 + 18a895e
